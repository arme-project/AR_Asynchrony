...
whiteImage(:,:,1:3) = 255;
whiteImage = imresize(whiteImage,0.25,'nearest');
circleMask = imresize(circleMask, 0.25, 'lanczos3');
circleMask = uint8(ones(imageOrigY,imageOrigX,1));
alphaImage = cat(3, whiteImage, circleMask*255);
...
ffmpeg_mp4 = "ffmpeg -i whiteflashAlphaVideo.mp4 -i audio_beep_48k.wav MergedWhiteBeepVideo.mp4";
system(ffmpeg_mp4)
